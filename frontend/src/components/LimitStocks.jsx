...
function LimitStocks({ onBack }) {
  ...
  return (
    <div className="limit-stocks">
      <div className="page-header">
        <button className="back-btn" onClick={onBack}>← 返回首頁</button>
        <h2 className="page-title">漲跌停排行</h2>
      </div>
